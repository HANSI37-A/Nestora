...
const Designers = () => {
  ...
  const handleInquirySubmit = (e) => {
    e.preventDefault();
    alert("Inquiry successfully transmitted to our Atelier.");
  };
  ...
  return (
    <div className="min-h-screen bg-[#F9F7F2] text-[#1A1A1A] font-sans antialiased selection:bg-[#1A1A1A] selection:text-white">
      ...
      <section className="px-6 pt-20 pb-12 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        {/* Dynamic MongoDB Data Grid mapping */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14">
          {designers.map((designer) => (
            <div key={designer._id} className="group space-y-6">
              ...
              <p className="text-xs text-[#555] font-light leading-relaxed tracking-wide transition-colors duration-300 group-hover:text-[#1A1A1A]">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-24 max-w-7xl mx-auto border-t border-[#1A1A1A]/5 grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
        <div className="md:col-span-5 space-y-10">
          ...
          <div className="space-y-6 pt-4">
            <div className="space-y-1">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#1A1A1A]">Milan Studio</h4>
              <p className="text-xs text-[#A8A29E] font-light leading-relaxed">Via della Spiga, 15<br />20121 Milano MI, Italy</p>
            </div>
            <div className="space-y-1">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#1A1A1A]">Office Hours</h4>
        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <form onSubmit={handleInquirySubmit} className="space-y-10 w-full">
            <div className="space-y-2 relative">
              ...
              <input type="email" placeholder="studio@example.com" className="w-full bg-transparent text-sm tracking-wide text-[#1A1A1A] border-b border-[#1A1A1A]/10 pb-3 focus:outline-none focus:border-[#1A1A1A] transition-colors placeholder:text-[#A8A29E]/40 font-light" required />
            </div>
            <div className="space-y-2 relative">
              <label className="block text-[9px] font-bold tracking-[0.2em] uppercase text-[#A8A29E]">Message</label>
              <textarea rows="4" placeholder="Describe your project or inquiry..." className="w-full bg-transparent text-sm tracking-wide text-[#1A1A1A] border-b border-[#1A1A1A]/10 pb-2 focus:outline-none focus:border-[#1A1A1A] transition-colors placeholder:text-[#A8A29E]/40 font-light resize-none" required></textarea>
            </div>
            <div className="pt-4">
              <button type="submit" className="bg-[#1A1A1A] text-white text-[10px] font-bold tracking-[0.25em] uppercase px-10 py-4 hover:bg-[#A8A29E] transition-colors duration-300 shadow-sm">Send Inquiry</button>
            </div>
          </form>
        </div>
      </section>
